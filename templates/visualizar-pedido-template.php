...
<div class="pedido-container">
    ...
    <p><strong>Garantia:</strong> Válida até - <span data-end="<?php echo "2024-08-01"; ?>" id="warranty-valid-until"><?php echo esc_html($csv_data[0][4]); ?></span> - <span id="warranty-status"></span></p>
    <hr>
